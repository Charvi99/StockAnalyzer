...
from app.api.routes import health, stocks, prices, analysis, ml, sentiment, patterns, chart_patterns, strategies, ml_predictions, risk_management, dividend_split_signals, news, ledger, backtest, ga
...
app.include_router(ga.router, prefix="/api/v1/ga-runs", tags=["ga"])  # Phase 3 GA weight optimization
